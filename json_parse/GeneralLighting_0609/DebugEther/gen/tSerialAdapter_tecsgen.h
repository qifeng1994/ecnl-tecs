...
#define tSerialAdapter_cSerialPort_close( subscript ) \
	  ...
	  tSerialAdapter_SINGLE_CELL_INIB.cSerialPort[subscript] )
#define tSerialAdapter_cSerialPort_read( subscript, buffer, length, tmout ) \
	  tSerialAdapter_SINGLE_CELL_INIB.cSerialPort[subscript]->VMT->read__T( \
	  tSerialAdapter_SINGLE_CELL_INIB.cSerialPort[subscript], (buffer), (length), (tmout) )
...
#define cSerialPort_read( subscript, buffer, length, tmout ) \
          tSerialAdapter_cSerialPort_read( subscript, buffer, length, tmout )
