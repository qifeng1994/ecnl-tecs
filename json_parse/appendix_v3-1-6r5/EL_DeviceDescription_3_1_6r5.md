...
"definitions":{
    ...
    "state_AUTO-NONAUTO-4142":{
        ...
        "enum":[
            ...
            {"edt":"0x42", "state":{"ja":"非AUTO", "en":"Non-automatic"}}
        ]
    },
    ...
    "state_NoHotWater-FE":{
        ...
        "size":1,
        "enum":[
            {"edt":"0xFE", "state":{"ja":"熱水不使用", "en":"Not to use warm water"} }
        ]
    },
    "state_Undefined-FF":{
        "type":"state",
    ...
    "state_Undefined-FFFF":{
        ...
        "size":2,
        "enum":[
            {"edt":"0xFFFF", "state":{"ja":"不明", "en":"Undefined"}, "readOnly":true}
        ]
    },
    "state_AUTO-FFFF":{
        "type":"state",
        "size":2,
        "enum":[
            {"edt":"0xFFFF", "state":{"ja":"自動", "en":"AUTO"}}
        ]
    },
    "level_21-15":{
        "type":"level",
...
0x03D5|食器洗い乾燥機| Dishwasher and dryer
...
"0x0012":{
    ...
    "elProperties":{
        "0xE0":{
            "validRelease":{"from":"A", "to":"latest"},
            "propertyName":{"ja":"相対湿度計測値", "en":"Measured value of relative humidity"},
            "accessRule":{"get":"required", "set":"notApplicable", "inf":"optional"},
            "data":{ "$ref":"#/definitions/number_0-100%" }
        }
    }
...
| 0xA1 | 風向自動設定 |Automatic control of air flow direction setting
...
"0x0130":{
    ...
    "elProperties":{
        ...
        "0x91":{
            "validRelease":{"from":"A", "to":"latest"},
            "propertyName":{"ja":"ONタイマ時刻設定値", "en":"ON timer setting(time)"},
            "accessRule":{"get":"optional", "set":"optional", "inf":"optional"},
        ...
        "0x95":{
            "validRelease":{"from":"A", "to":"latest"},
            "propertyName":{"ja":"OFFタイマ時刻設定値", "en":"OFF timer setting(time)"},
            "accessRule":{"get":"optional", "set":"optional", "inf":"optional"},
            "data":{ "type":"time", "size":2 }
        },
        "0x96":{
        ...
        "0xA1":{
            "validRelease":{"from":"A", "to":"latest"},
            "propertyName":{"ja":"風向自動設定", "en":"Automatic control of air flow direction setting"},
            "accessRule":{"get":"optional", "set":"optional", "inf":"optional"},
            "data":{
                "type":"state",
                "size":1,
...
0xB0 | 換気モード自動設定 | Ventilation mode automatic mode setting
0xB1 | 換気方式設定 | Ventilation method setting
0xB2 | 換気モード設定 | Ventilation mode setting
0xB3 | 冷暖強弱設定 | Cooling / heating high-low setting
0xB4 | 室内相対湿度設定値 | Set value of room relative humidity
0xB9 | 消費電流計測値 | Measured value of electric current consumption
0xBA | 室内相対湿度計測値 | Measured value of room relative humidity
...
0xCA | 外気相対湿度計測値 | Measured value of outdoor relative humidity
0xD0 | 還気温度計測値 | Measured value of return air temperature
0xD1 | 還気相対湿度計測値 | Measured value of return relative humidity
0xD2 | 給気温度計測値 | Measured value of charging air temperature
0xD3 | 給気相対湿度計測値 | Measured value of charging relative humidity
0xD4 | 排気温度計測値 | Measured value of discharging air temperature
0xD5 | 排気相対湿度計測値 | Measured value of discharging air relative humidity
...
"0x0134":{
    ...
    "elProperties":{
        ...
        "0xB0":{
            ...
            "propertyName":{"ja":"換気モード自動設定", "en":"Ventilation mode automatic mode setting"},
            "accessRule":{"get":"optional", "set":"optional", "inf":"optional"},
            "data":{ "$ref":"#/definitions/state_AUTO-NONAUTO-4142" }
        },
        "0xB1":{
            "validRelease":{"from":"M", "to":"latest"},
            "propertyName":{"ja":"換気方式設定", "en":"Ventilation method setting"},
            "accessRule":{"get":"optional", "set":"optional", "inf":"optional"},
            "data":{
                "type":"state",
                "size":1,
                "enum":[
                    {"edt":"0x41", "state":{"ja":"送風換気", "en":"Blowing ventilation "}},
                    {"edt":"0x42", "state":{"ja":"空調換気", "en":"Air conditioning ventilation"}}
                ]
            }
        },
        "0xB2":{
            "validRelease":{"from":"M", "to":"latest"},
            "propertyName":{"ja":"換気モード設定", "en":"Ventilation mode setting"},
            "accessRule":{"get":"optional", "set":"optional", "inf":"required"},
            "data":{
                "type":"state",
                "size":1,
                "enum":[
                    {"edt":"0x41", "state":{"ja":"普通換気", "en":"normal"}},
                    {"edt":"0x42", "state":{"ja":"熱交換換気", "en":"heat-exchange"}},
                    {"edt":"0x43", "state":{"ja":"冷房換気", "en":"cooling"}},
                    {"edt":"0x44", "state":{"ja":"暖房換気", "en":"heating"}},
                    {"edt":"0x45", "state":{"ja":"除湿換気", "en":"dehumidifying"}},
                    {"edt":"0x46", "state":{"ja":"加湿換気", "en":"humidifying"}},
                    {"edt":"0x40", "state":{"ja":"その他換気", "en":"other"}}
                ]
            }
        },
        "0xB3":{
            "validRelease":{"from":"M", "to":"latest"},
            "propertyName":{"ja":"冷暖強弱設定", "en":"Cooling / heating high-low setting"},
            "accessRule":{"get":"optional", "set":"optional", "inf":"optional"},
            "data":{ "$ref":"#/definitions/level_31-8" }
        },
        "0xB4":{
        ...
        "0xB9":{
            "validRelease":{"from":"M", "to":"latest"},
            "propertyName":{"ja":"消費電流計測値", "en":"Measured value of electric current consumption"},
            "accessRule":{"get":"optional", "set":"notApplicable", "inf":"optional"},
            "data":{ "$ref":"#/definitions/number_0-65533", "unit":"A", "multipleOf":0.1 }
        },
        "0xBA":{
        ...
        "0xCA":{
            "validRelease":{"from":"M", "to":"latest"},
            "propertyName":{"ja":"外気相対湿度計測値", "en":"Measured value of outdoor relative humidity"},
            "accessRule":{"get":"optional", "set":"notApplicable", "inf":"optional"},
            "data":{ "$ref":"#/definitions/number_0-100%" }
        },
        "0xD0":{
            "validRelease":{"from":"M", "to":"latest"},
            "propertyName":{"ja":"還気温度計測値", "en":"Measured value of return air temperature"},
            "accessRule":{"get":"optional", "set":"notApplicable", "inf":"optional"},
            "data":{
                "type":"array",
                "itemSize":1,
        ...
        "0xD1":{
            "validRelease":{"from":"M", "to":"latest"},
            "propertyName":{"ja":"還気相対湿度計測値", "en":"Measured value of return relative humidity"},
            "accessRule":{"get":"optional", "set":"notApplicable", "inf":"optional"},
            "data":{
                "type":"array",
                "itemSize":1,
        ...
        "0xD2":{
            "validRelease":{"from":"M", "to":"latest"},
            "propertyName":{"ja":"給気温度計測値", "en":"Measured value of charging air temperature"},
            "accessRule":{"get":"optional", "set":"notApplicable", "inf":"optional"},
            "data":{ "$ref":"#/definitions/number_-127-125Celsius" }
        },
        "0xD3":{
            "validRelease":{"from":"M", "to":"latest"},
            "propertyName":{"ja":"給気相対湿度計測値", "en":"Measured value of charging relative humidity"},
            "accessRule":{"get":"optional", "set":"notApplicable", "inf":"optional"},
            "data":{ "$ref":"#/definitions/number_0-100%" }
        },
        "0xD4":{
            "validRelease":{"from":"M", "to":"latest"},
            "propertyName":{"ja":"排気温度計測値", "en":"Measured value of discharging air temperature"},
            "accessRule":{"get":"optional", "set":"notApplicable", "inf":"optional"},
            "data":{ "$ref":"#/definitions/number_-127-125Celsius" }
        },
        "0xD5":{
            "validRelease":{"from":"M", "to":"latest"},
            "propertyName":{"ja":"排気相対湿度計測値", "en":"Measured value of discharging air relative humidity"},
            "accessRule":{"get":"optional", "set":"notApplicable", "inf":"optional"},
            "data":{ "$ref":"#/definitions/number_0-100%" }
        },
        "0xE0":{
...
## レンジフード: Range hood: 0x015A
### Properties

|  EPC | プロパティ名称| Property name
|:-----|:----------------|:----------------|
| 0xA0 | 換気風量設定 | Ventilation air flow rate setting
| 0xBF | レンジフード自動設定 | Range hood automatic setting
| 0xC0 | 室内温度計測値 | Measured value of indoor temperature
| 0xC1 | 室外温度計測値 | Measured value of outdoor temperature
| 0xC2 | 給気温度計測値 | Measured value of charging air temperature
| 0xC3 | 調理温度計測値 | Measured value of cooking temperature
| 0xC4 | 室内相対湿度計測値 | Measured value of indoor relative humidity
| 0xC5 | 室外相対湿度計測値 | Measured value of outdoor relative humidity
| 0xC6 | 人体検知閾値レベル設定 | Human detection threshold level setting
| 0xC7 | 人体検知状態 | Human detection status
| 0xC8 | CO2 濃度計測値 | Measured value of CO2 concentration
| 0xC9 | ガス検知閾値レベル状態 | Gas detection threshold level
| 0xCA | ガス検知状態 | Gas detection status
| 0xCB | エラー検知モード | Error detection mode
| 0xD0 | 照明動作設定 | Lighting operation setting
| 0xD1 | 光源色設定 | Light source color setting
| 0xD2 | 輝度レベル設定 | Brightness level setting
| 0xD6 | 点灯モード設定 | Lighting mode setting
| 0xE0 | カラー灯モード時RGB 設定 | When in colored lighting mode RGB setting
...
"0x015A":{
    "validRelease":{"from":"M", "to":"latest"},
    "className":{"ja":"レンジフード", "en":"Range hood"},
    "elProperties":{
        "0xA0":{
            "validRelease":{"from":"M", "to":"latest"},
            "propertyName":{"ja":"換気風量設定", "en":"Ventilation air flow rate setting"},
        ...
        "0xBF":{
            "validRelease":{"from":"M", "to":"latest"},
            "propertyName":{"ja":"レンジフード自動設定", "en":"Range hood automatic setting"},
            "accessRule":{"get":"optional", "set":"optional", "inf":"optional"},
            "data":{ "$ref":"#/definitions/state_YES-NO-4142" }
        },
        "0xC0":{
            "validRelease":{"from":"M", "to":"latest"},
            "propertyName":{"ja":"室内温度計測値", "en":"Measured value of indoor temperature"},
            "accessRule":{"get":"optional", "set":"notApplicable", "inf":"optional"},
            "data":{ "$ref":"#/definitions/number_-2732-32766", "unit":"Celsius", "multipleOf":0.1 }
        },
        "0xC1":{
            "validRelease":{"from":"M", "to":"latest"},
            "propertyName":{"ja":"室外温度計測値", "en":"Measured value of outdoor temperature"},
            "accessRule":{"get":"optional", "set":"notApplicable", "inf":"optional"},
            "data":{ "$ref":"#/definitions/number_-2732-32766", "unit":"Celsius", "multipleOf":0.1 }
        },
        "0xC2":{
        ...
        "0xC3":{
            "validRelease":{"from":"M", "to":"latest"},
            "propertyName":{"ja":"調理温度計測値", "en":"Measured value of cooking temperature"},
            "accessRule":{"get":"optional", "set":"notApplicable", "inf":"optional"},
            "data":{ "$ref":"#/definitions/number_-2732-32766", "unit":"Celsius", "multipleOf":0.1 }
        },
        "0xC4":{
            "validRelease":{"from":"M", "to":"latest"},
            "propertyName":{"ja":"室内相対湿度計測値", "en":"Measured value of indoor relative humidity"},
            "accessRule":{"get":"optional", "set":"notApplicable", "inf":"optional"},
            "data":{ "$ref":"#/definitions/number_0-100%" }
        },
        "0xC5":{
            "validRelease":{"from":"M", "to":"latest"},
            "propertyName":{"ja":"室外相対湿度計測値", "en":"Measured value of outdoor relative humidity"},
            "accessRule":{"get":"optional", "set":"notApplicable", "inf":"optional"},
            "data":{ "$ref":"#/definitions/number_0-100%" }
        },
        "0xC6":{
            "validRelease":{"from":"M", "to":"latest"},
            "propertyName":{"ja":"人体検知閾値レベル設定", "en":"Human detection threshold level setting"},
            "accessRule":{"get":"optional", "set":"optional", "inf":"optional"},
            "data":{ "$ref":"#/definitions/level_31-8" }
        },
        "0xC7":{
        ...
        "0xC8":{
            "validRelease":{"from":"M", "to":"latest"},
            "propertyName":{"ja":"CO2 濃度計測値", "en":"Measured value of CO2 concentration"},
            "accessRule":{"get":"optional", "set":"notApplicable", "inf":"optional"},
            "data":{ "$ref":"#/definitions/number_0-65533", "unit":"ppm" }
        },
        "0xC9":{
            "validRelease":{"from":"M", "to":"latest"},
            "propertyName":{"ja":"ガス検知閾値レベル状態", "en":"Gas detection threshold level"},
            "accessRule":{"get":"optional", "set":"optional", "inf":"optional"},
            "data":{ "$ref":"#/definitions/level_31-8" }
        },
        "0xCA":{
        ...
        "0xCB":{
            "validRelease":{"from":"M", "to":"latest"},
            "propertyName":{"ja":"エラー検知モード", "en":"Error detection mode"},
            "accessRule":{"get":"optional", "set":"notApplicable", "inf":"optional"},
            "data":{
                "type":"state",
                "size":1,
                "enum":[
                    {"edt":"0x41", "state":{"ja":"モーターエラー状態", "en":"Motor Error"}},
                    {"edt":"0x42", "state":{"ja":"整流板検知状態", "en":"Current Plate Detection"}},
                    {"edt":"0x43", "state":{"ja":"正常状態", "en":"Normal"}},
                    {"edt":"0x40", "state":{"ja":"その他", "en":"Other"}}
                ]
            }
        },
        "0xD0":{
            "validRelease":{"from":"M", "to":"latest"},
            "propertyName":{"ja":"照明動作設定", "en":"Lighting operation setting"},
            "accessRule":{"get":"optional", "set":"optional", "inf":"required"},
            "data":{
                "type":"state",
                "size":1,
                "enum":[
                    {"edt":"0x41", "state":{"ja":"点灯", "en":"Lighting"}},
                    {"edt":"0x42", "state":{"ja":"消灯", "en":"Lights-out"}},
                    {"edt":"0x43", "state":{"ja":"点滅", "en":"Flicker "}}
                ]
            }
        },
        "0xD1":{
            "validRelease":{"from":"M", "to":"latest"},
            "propertyName":{"ja":"光源色設定", "en":"Light source color setting"},
            "accessRule":{"get":"optional", "set":"optional", "inf":"optional"},
            "data":{ "$ref":"#/definitions/state_LightColor-40-44" }
        },
        "0xD2":{
            "validRelease":{"from":"M", "to":"latest"},
            "propertyName":{"ja":"輝度レベル設定", "en":"Brightness level setting"},
            "accessRule":{"get":"optional", "set":"optional", "inf":"optional"},
            "data":{ "$ref":"#/definitions/number_0-100%" }
        },
        "0xD6":{
            ...
            "data":{
                ...
                "enum":[
                    {"edt":"0x41", "state":{"ja":"自動", "en":"Automatic"}},
                    {"edt":"0x42", "state":{"ja":"通常灯", "en":"Normal Lighting"}},
                    {"edt":"0x43", "state":{"ja":"カラー灯", "en":"Color Lighting"}}
                ]
            }
        },
        "0xE0":{
            "validRelease":{"from":"M", "to":"latest"},
            "propertyName":{"ja":"カラー灯モード時RGB 設定", "en":"When in colored lighting mode RGB setting"},
            "accessRule":{"get":"optional", "set":"optional", "inf":"optional"},
            "data":{
                "type":"object",
                "properties":[
...
:-----|:----------------|:-----
0x90 | ONタイマ予約設定 | ON timer setting
0x91 | ONタイマ時刻設定値 | ON timer setting(time)
0x92 | ONタイマ相対時間設定値 | ON timer setting(relative time)
0x94 | OFFタイマ予約設定 | OFF timer setting
0x95 | OFFタイマ時刻設定値 | OFF timer setting(time)
0x96 | OFFタイマ相対時間設定値 | OFF timer setting(relative time)
0xD1 | 冷水温設定２設定可能最大レベル | Cold water temperature setting 2 Maximum allowable setting level
0xD2 | 温水温設定２設定可能最大レベル | Warm water temperature setting 2 Maximum allowable setting level
0xE0 | 運転モード設定 | Operation mode setting
0xE1 | 水温設定１ | Water temperature1
0xE2 | 水温設定２ | Water temperature2
0xE3 | 往き水温計測値（出口水温） | Measured temperature of outward water (Exit water Temperature)
0xE4 | 戻り水温計測値（入口水温） | Measured temperature of inward water (Entrance water Temperature)
0xE5 | 特殊運転設定 | Special operation setting
0xE6 | デイリータイマー設定 | Daily timer setting
0xE7 | デイリータイマー1設定 | Daily timer setting 1
0xE8 | デイリータイマー2設定 | Daily timer setting 2
0xE9 | 定格消費電力値 | Rated power consumption
0xEA | 消費電力計測方法 | Power consumption measurement method
...
"0x027A":{
    ...
    "elProperties":{
        ...
        "0xD1":{
            "validRelease":{"from":"M", "to":"latest"},
            "propertyName":{"ja":"冷水温設定２設定可能最大レベル", "en":"Cold water temperature setting 2 Maximum allowable setting level"},
            "accessRule":{"get":"optional", "set":"optional", "inf":"required"},
            "data":{
                "type":"number",
                "format":"uint8",
        ...
        "0xD2":{
            "validRelease":{"from":"M", "to":"latest"},
            "propertyName":{"ja":"温水温設定２設定可能最大レベル", "en":"Warm water temperature setting 2 Maximum allowable setting level"},
            "accessRule":{"get":"optional", "set":"optional", "inf":"required"},
            "data":{
                "type":"number",
                "format":"uint8",
        ...
        "0xE1":{
            "validRelease":{"from":"A", "to":"latest"},
            "propertyName":{"ja":"水温設定1", "en":"Water temperature1"},
            "accessRule":{"get":"required_c", "set":"required_c", "inf":"optional"},
            "data":{
                "oneOf":[
                    { "$ref":"#/definitions/number_0-100Celsius" },
        ...
        "0xE2":{
            "validRelease":{"from":"A", "to":"latest"},
            "propertyName":{"ja":"水温設定2", "en":"Water temperature2"},
            "accessRule":{"get":"required_c", "set":"required_c", "inf":"optional"},
            "data":{
                "oneOf":[
...
0x95 | OFFタイマ時刻設定値 | OFF timer setting(time)
0x96 | OFFタイマ相対時間設定値 | OFF timer setting(relative time)
0xD1 | 温度設定2 設定可能最大レベル | Maximum allowable setting level for temperature setting 2
0xE0 | 温度設定1 | Temperature1
0xE1 | 温度設定2 | Temperature2
0xE2 | 室内温度計測値 | Measured room temperature
0xE3 | 床温度計測値 | Measured floor temperature
0xE4 | ゾーン切替え設定 | Zone change setting
0xE5 | 特殊運転設定 | Special operation setting
0xE6 | デイリータイマー設定 | Daily timer setting
0xE7 | デイリータイマー１設定 | Daily timer setting 1
0xE8 | デイリータイマー２設定 | Daily timer setting 2
0xE9 | 定格消費電力値 | Rated power consumption
0xEA | 消費電力計測方法 | Power consumption measurement method
...
"0x027B":{
    ...
    "elProperties":{
        ...
        "0xD1":{
            "validRelease":{"from":"M", "to":"latest"},
            "propertyName":{"ja":"温度設定2 設定可能最大レベル", "en":"Maximum allowable setting level for temperature setting 2"},
            "accessRule":{"get":"optional", "set":"notApplicable", "inf":"required"},
            "data":{ "$ref":"#/definitions/number_49-63" }
        },
        "0xE0":{
            "validRelease":{"from":"A", "to":"latest"},
...
0xC2 | 定格発電出力 |Rated power generation output
...
0xCC | 宅内瞬時消費電力計測値 |Measured in-house instantaneous power consumption
0xCD | 宅内積算消費電力量計測値 |Measured in-house cumulative power consumption
0xCE | 宅内積算消費電力量リセット設定 |In-house cumulative power consumption reset
0xD0 | 系統連系状態 |System interconnected type
0xD1 | 発電要請時刻設定 |Power generation request time setting
0xD2 | 指定発電状態 |Designated power generation status
...
0x97| 現在時刻設定 |Current time setting
0x98| 現在年月日設定 |Current date setting
0xA0| AC実効容量（充電） |AC effective capacity(charging)
0xA1| AC実効容量（放電） |AC effective capacity(discharging)
0xA2| AC充電可能容量 |AC chargeable capacity
0xA3| AC放電可能容量 |AC dischargeable capacity
0xA4| AC充電可能量 |AC chargeable electric energy
0xA5| AC放電可能量 |AC dischargeable electric energy
0xA6| AC充電上限設定 |AC charge upper limit setting
0xA7| AC充電下限設定 |AC discharge lower limit setting
0xA8| AC積算充電電力量計測値 |AC measured cumulative charging electric energy
0xA9| AC積算放電電力量計測値 |AC measured cumulative discharging electric energy
0xAA| AC充電量設定値 |AC charge amount setting value
0xAB| AC放電量設定値 |AC discharge amount setting value
0xC1| 充電方式 | Charging method
0xC2| 放電方式 | Discharging method
0xC7| AC定格電力量 |AC rated electric energy
0xC8| 最小最大充電電力値 |Min/Max charging electric power
0xC9| 最小最大放電電力値 |Min/Max discharging electric power
0xCA| 最小最大充電電流値 |Minimum/maximum charging current
0xCB| 最小最大放電電流値 |Minimum/maximum discharging current
0xCC| 再連携許可設定 |Re-interconnection permission setting
0xCD| 運転許可設定 |Operation permission setting
0xCE| 自立運転許可設定 |Independent operation permission setting
0xCF| 運転動作状態 |Working operation status
0xD0| 定格電力量 |Rated electric energy
0xD1| 定格容量 |Rated capacity
0xD2| 定格電圧 |Rated voltage
0xD3| 瞬時充放電電力計測値 |Measured instantaneous charging/discharging electric energy
0xD4| 瞬時充放電電流計測値 |Measured instantaneous charging/discharging current
0xD5| 瞬時充放電電圧計測値 |Measured instantaneous charging/discharging voltage
0xD6| 積算放電電力量計測値 |Measured cumulative discharging electric energy
0xD7| 積算放電電力量リセット設定 |Measured cumulative discharging electric energy reset setting
0xD8| 積算充電電力量計測値 |Measured cumulative charging electric energy
0xD9| 積算充電電力量リセット設定 |Measured cumulative charging electric energy reset setting
0xDA| 運転モード設定 |Operation mode setting
0xDB| 系統連系状態 |System-interconnected type
0xDC| 最小最大充電電力値（独立時） |Minimum/maximum charging power (Independent)
0xDD| 最小最大放電電力値（独立時） |Minimum/maximum discharging power (Independent)
0xDE| 最小最大充電電流値（独立時） |Minimum/maximum charging current (Independent)
0xDF| 最小最大放電電流値（独立時） |Minimum/maximum discharging current (Independent)
0xE0| 充放電量設定値1 |Charging/discharging amount setting 1
0xE1| 充放電量設定値2 |Charging/discharging amount setting 2
0xE2| 蓄電残量1 |Remaining stored electricity 1
0xE3| 蓄電残量2 |Remaining stored electricity 2
0xE4| 蓄電残量3 |Remaining stored electricity 3
0xE5| 劣化状態 |Battery state of health
0xE6| 蓄電池タイプ |Battery type
0xE7| 充電量設定値1 |Charging amount setting 1
0xE8| 放電量設定値1 |Discharging amount setting 1
0xE9| 充電量設定値2 |Charging amount setting 2
0xEA| 放電量設定値2 |Discharging amount setting 2
0xEB| 充電電力設定値 |Charging electric energy setting
0xEC| 放電電力設定値 |Discharging electric energy setting
0xED| 充電電流設定値 |Charging current setting
0xEE| 放電電流設定値 |Discharging current setting
0xEF| 定格電圧（独立時） |Rated voltage (Independent)
...
"0x027D":{
    ...
    "elProperties":{
        ...
        "0xC1":{
            "validRelease":{"from":"M", "to":"latest"},
            "propertyName":{"ja":"充電方式", "en":"Charging method"},
            "accessRule":{"get":"required", "set":"optional", "inf":"required"},
            "data":{
                "type":"state",
                "size":1,
                "enum":[
                    {"edt":"0x01", "state":{"ja":"最大充電電力充電", "en":"Maximum charging electric energy charting"}},
                    {"edt":"0x02", "state":{"ja":"余剰電力充電", "en":"Surplus electric energy charging"}},
                    {"edt":"0x03", "state":{"ja":"指定電力充電", "en":"Designated electric energy charging"}},
                    {"edt":"0x04", "state":{"ja":"指定電流充電", "en":"Designated current power charging"}},
                    {"edt":"0x00", "state":{"ja":"その他", "en":"Others"}}
                ]
            }
        },
        "0xC2":{
            "validRelease":{"from":"M", "to":"latest"},
            "propertyName":{"ja":"放電方式", "en":"Discharging method"},
            "accessRule":{"get":"required", "set":"optional", "inf":"required"},
            "data":{
                "type":"state",
                "size":1,
                "enum":[
                    {"edt":"0x01", "state":{"ja":"最大放電電力放電", "en":"Maximum discharge electric energy discharging"}},
                    {"edt":"0x02", "state":{"ja":"余剰電力放電", "en":"Load following discharge"}},
                    {"edt":"0x03", "state":{"ja":"指定電力放電", "en":"Designated electric energy discharging"}},
                    {"edt":"0x04", "state":{"ja":"指定電流放電", "en":"Designated current power discharging"}},
                    {"edt":"0x00", "state":{"ja":"その他", "en":"Others"}}
                ]
            }
        },
...
0x94 | OFFタイマ予約設定 |OFF timer setting
0x95 | OFFタイマ時刻設定値 |OFF timer setting(time)
0xB0 | 照度レベル設定|Illuminance Level
0xB1 | 光色設定|Light color setting
0xB2 | 照度レベル段数設定|Brightness level step setting
0xB3 | 光色レベル段数設定|Light color step setting
0xB4 | 設定可能レベル最大値|Maximum specifiable values
0xB5 | 常夜灯設定可能レベル最大値|Maximum value of settable level for night lighting
0xB6 | 点灯モード設定|Lighting mode setting
0xB7 | 通常灯モード時照度レベル設定|Brightness level setting for main lighting
0xB8 | 通常灯モード時照度レベル段数設定|Brightness level step setting for main lighting
0xB9 | 常夜灯モード時照度レベル設定|Brightness level setting for night lighting
0xBA | 常夜灯モード時照度レベル段数設定|Brightness level step setting for night lighting
0xBB | 通常灯モード時光色設定|Light color setting for main lighting
0xBC | 通常灯モード時光色レベル段数設定|Light color level step setting for main lighting
0xBD | 常夜灯モード時光色設定|Light color setting for night lighting
0xBE | 常夜灯モード時光色レベル段数設定|Light color level step setting for night lighting
0xBF | 自動モード時点灯モード状態|Lighting mode status in Auto mode
0xC0 | RGB設定|RGB Setting
            ...
            "oneOf":[
                {
                    ...
                    "accessRule":{"get":"optional", "set":"optional", "inf":"optional"},
                    "data":{ "$ref":"#/definitions/state_LightColor-41-44" }
                },
                {
                    "validRelease":{"from":"C", "to":"latest"},
                    "propertyName":{"ja":"光色設定", "en":"Light color setting"},
    ...
    "elProperties":{
        ...
        "0xD6":{
            ...
            "data":{
                "oneOf":[
                    ...
                    { "$ref":"#/definitions/level_A0-8" },
                    { "$ref":"#/definitions/level_C0-8" },
        ...
        "0xD7":{
            ...
            "data":{
                "oneOf":[
                    ...
                    { "$ref":"#/definitions/level_A000-2048" },
                    { "$ref":"#/definitions/level_C000-2048" },
        ...
        "0xE1":{
            ...
            "data":{
                "oneOf":[
                    { "type":"time", "size":2 },
                    { "$ref":"#/definitions/level_A000-60" },
                    { "$ref":"#/definitions/level_C000-60" },
                    { "$ref":"#/definitions/state_AUTO-FFFF" }
                ]
            },
            "note":{
        ...
        "0xE3":{
            ...
            "data":{
                "oneOf":[
                    ...
                    { "$ref":"#/definitions/level_A0-32" },
                    { "$ref":"#/definitions/level_C0-32" },
                    { "$ref":"#/definitions/state_AUTO-FF" }
                ]
            },
            "note":{
...
## 食器洗い乾燥機: Dishwasher and dryer: 0x03D5
...
| 0x91 | ONタイマ時刻設定値 |ON timer setting(time)
| 0x92 | ONタイマ相対時間設定値 |ON timer setting(relative time)
| 0xB0 | 扉・蓋開閉設定 | Door/cover open/close setting
| 0xB1 | 扉・蓋ロック設定 | Door/cover lock setting
| 0xB2 | 運転状態設定 | Operation status setting
| 0xD0 | 洗浄方法設定 | Dish-washing method setting
| 0xD1 | 乾燥方法設定 | Drying cycle setting
| 0xD2 | 保管方法設定 | Storing method setting
| 0xD3 | 洗浄方法設定可能情報 | Dish-washing method setting acceptable information
| 0xD4 | 乾燥方法設定可能情報 | Drying cycle setting acceptable information
| 0xD5 | 保管方法設定可能情報 | Storing method setting acceptable information
| 0xD6 | 予洗い時間設定値 | Prewashing time setting
| 0xD7 | 予洗い最高水温設定値 | Highest water temperature setting for prewashing
| 0xD8 | 本洗い時間設定値 | Washing time setting
| 0xD9 | 本洗い最高水温設定値 | Highest water temperature setting for washing
| 0xDA | すすぎ回数設定値 | Number of times of rinsing setting
| 0xDB | すすぎモード設定 | Rinsing mode setting
| 0xDC | 熱水すすぎ最高水温設定値 | Highest water temperature setting for hot water rinsing
| 0xDD | 洗浄水量設定 | Dish-washing water volume setting
| 0xDE | 洗浄水圧設定 | Dish-washing water pressure setting
| 0xDF | 洗浄度設定 | Dish-washing level setting
| 0xE0 | 乾燥時間設定値 | Drying time setting
| 0xE1 | 熱風乾燥最高気温設定値 | Highest air temperature setting for hot air drying
| 0xE2 | 乾燥風量設定 | Drying air flow rate setting
| 0xE3 | 乾燥度設定 | Drying level setting
| 0xE4 | 保管時間設定値 | Storing time setting
| 0xE5 | 運転設定情報 | Operation setting information
| 0xE6 | 運転遷移状態 | Operation transition status
| 0xE7 | ON タイマ残り時間 | Remaining time on the ON timer
| 0xE8 | 予洗い残り時間 | Remaining time of prewashing
| 0xE9 | 本洗い残り時間 | Remaining time of washing
| 0xEA | すすぎ残り時間 | Remaining time for rinsing
| 0xEB | 洗浄残り時間 | Remaining time of dish-washing
| 0xEC | 乾燥残り時間 | Remaining drying time
| 0xED | 洗乾残り時間 | Remaining time of washing and drying
| 0xEE | 保管経過時間 | Storing elapsed time
| 0xEF | 使用水量 | Used water volume
...
"0x03D5":{
    "validRelease":{"from":"M", "to":"latest"},
    "className":{"ja":"食器洗い乾燥機", "en":"Dishwasher and dryer"},
    "elProperties":{
          "0x90":{
            "validRelease":{"from":"M", "to":"latest"},
            "propertyName":{"ja":"ONタイマ予約設定", "en":"ON timer setting"},
        ...
        "0xB0":{
            "validRelease":{"from":"M", "to":"latest"},
            "propertyName":{"ja":"扉・蓋開閉設定", "en":"Door/cover open/close setting"},
            "accessRule":{"get":"optional", "set":"optional", "inf":"optional"},
            "data":{ "$ref":"#/definitions/state_OPEN-CLOSE-4142" }
        },
        "0xB1":{
            "validRelease":{"from":"M", "to":"latest"},
            "propertyName":{"ja":"扉・蓋ロック設定", "en":"Door/cover lock setting"},
            "accessRule":{"get":"optional", "set":"optional", "inf":"optional"},
            "data":{ "$ref":"#/definitions/state_LOCK-UNLOCK-4142" }
        },
        "0xB2":{
            "validRelease":{"from":"M", "to":"latest"},
            "propertyName":{"ja":"運転状態設定", "en":"Operation status setting"},
            "accessRule":{"get":"optional", "set":"optional", "inf":"optional"},
            "data":{
                "type":"state",
                "size":1,
                "enum":[
                    {"edt":"0x41", "state":{"ja":"運転開始・再開/運転中", "en":"Start/restart(ed) or in progress"}},
                    {"edt":"0x42", "state":{"ja":"運転一時停止", "en":"Operation suspended"}},
                    {"edt":"0x43", "state":{"ja":"運転停止", "en":"Operation stopped"}}
                ]
            }
        },
        "0xD0":{
            "validRelease":{"from":"M", "to":"latest"},
            "propertyName":{"ja":"洗浄方法設定", "en":"Dish-washing method setting"},
            "accessRule":{"get":"optional", "set":"optional", "inf":"optional"},
            "data":{
                "type":"state",
                "size":1,
                "enum":[
                    {"edt":"0x40", "state":{"ja":"洗浄運転切", "en":"Dish-washing operation OFF"}},
                    {"edt":"0x41", "state":{"ja":"標準", "en":"Standard"}},
                    {"edt":"0x42", "state":{"ja":"静音", "en":"Silent"}},
                    {"edt":"0x43", "state":{"ja":"汚れ大", "en":"Heavily stained"}},
                    {"edt":"0x44", "state":{"ja":"しつこい汚れ", "en":"Hard-to-remove stains"}},
                    {"edt":"0x45", "state":{"ja":"ソフト", "en":"Soft"}},
                    {"edt":"0x46", "state":{"ja":"汚れ少", "en":"Lightly stained"}},
                    {"edt":"0x47", "state":{"ja":"少量短時間", "en":"Quick wash of small amount of laundry"}},
                    {"edt":"0x48", "state":{"ja":"すすぎのみ", "en":"Rinsing only"}},
                    {"edt":"0x49", "state":{"ja":"除菌", "en":"Disinfection"}},
                    {"edt":"0x4F", "state":{"ja":"お手入れ", "en":"Maintenance"}}
                ]
            }
        },
        "0xD1":{
            "validRelease":{"from":"M", "to":"latest"},
            "propertyName":{"ja":"乾燥方法設定", "en":"Drying cycle setting"},
            "accessRule":{"get":"optional", "set":"optional", "inf":"optional"},
            "data":{
                "type":"state",
                "size":1,
                "enum":[
                    {"edt":"0x80", "state":{"ja":"乾燥運転切", "en":"Drying operation OFF"}},
                    {"edt":"0x81", "state":{"ja":"最弱", "en":"Very low"}},
                    {"edt":"0x82", "state":{"ja":"弱", "en":"Low"}},
                    {"edt":"0x83", "state":{"ja":"標準", "en":"Standard"}},
                    {"edt":"0x84", "state":{"ja":"ソフト", "en":"Soft"}},
                    {"edt":"0x85", "state":{"ja":"強", "en":"High"}},
                    {"edt":"0x86", "state":{"ja":"最強", "en":"Very high"}},
                    {"edt":"0x87", "state":{"ja":"時間指定", "en":"User definition of drying time"}},
                    {"edt":"0x88", "state":{"ja":"乾燥のみ", "en":"Drying only"}},
                    {"edt":"0x8F", "state":{"ja":"庫内乾燥", "en":"Drying inside"}}
                ]
            }
        },
        "0xD2":{
            "validRelease":{"from":"M", "to":"latest"},
            "propertyName":{"ja":"保管方法設定", "en":"Storing method setting"},
            "accessRule":{"get":"optional", "set":"optional", "inf":"optional"},
            "data":{
                "type":"state",
                "size":1,
                "enum":[
                    {"edt":"0xC0", "state":{"ja":"保管運転切", "en":"Storing operation OFF"}},
                    {"edt":"0xC1", "state":{"ja":"送風", "en":"Blowing"}},
                    {"edt":"0xC2", "state":{"ja":"除湿", "en":"Dehumidification"}},
                    {"edt":"0xC3", "state":{"ja":"除菌", "en":"Disinfection"}}
                ]
            }
        },
        "0xD3":{
            "validRelease":{"from":"M", "to":"latest"},
            "propertyName":{"ja":"洗浄方法設定可能情報", "en":"Dish-washing method setting acceptable information"},
            "accessRule":{"get":"optional", "set":"notApplicable", "inf":"optional"},
            "data":{ "$ref":"#/definitions/raw_2" }
        },
        "0xD4":{
            "validRelease":{"from":"M", "to":"latest"},
            "propertyName":{"ja":"乾燥方法設定可能情報", "en":"Drying cycle setting acceptable information"},
            "accessRule":{"get":"optional", "set":"notApplicable", "inf":"optional"},
            "data":{ "$ref":"#/definitions/raw_2" }
        },
        "0xD5":{
            "validRelease":{"from":"M", "to":"latest"},
            "propertyName":{"ja":"保管方法設定可能情報", "en":"Storing method setting acceptable information"},
            "accessRule":{"get":"optional", "set":"notApplicable", "inf":"optional"},
            "data":{ "$ref":"#/definitions/raw_2" }
        },
        "0xD6":{
            "validRelease":{"from":"M", "to":"latest"},
            "propertyName":{"ja":"予洗い時間設定値", "en":"Prewashing time setting"},
            "accessRule":{"get":"optional", "set":"optional", "inf":"optional"},
            "data":{
                "oneOf":[
                    { "type":"time", "size":2 },
        ...
        "0xD7":{
            "validRelease":{"from":"M", "to":"latest"},
            "propertyName":{"ja":"予洗い最高水温設定値", "en":"Highest water temperature setting for prewashing"},
            "accessRule":{"get":"optional", "set":"optional", "inf":"optional"},
            "data":{
                "oneOf":[
                    { "$ref":"#/definitions/number_0-100Celsius" },
        ...
        "0xD8":{
            "validRelease":{"from":"M", "to":"latest"},
            "propertyName":{"ja":"本洗い時間設定値", "en":"Washing time setting"},
            "accessRule":{"get":"optional", "set":"optional", "inf":"optional"},
            "data":{
                "oneOf":[
                    { "type":"time", "size":2 },
        ...
        "0xD9":{
            "validRelease":{"from":"M", "to":"latest"},
            "propertyName":{"ja":"本洗い最高水温設定値", "en":"Highest water temperature setting for washing"},
            "accessRule":{"get":"optional", "set":"optional", "inf":"optional"},
            "data":{
                "oneOf":[
                    { "$ref":"#/definitions/number_0-100Celsius" },
        ...
        "0xDB":{
            "validRelease":{"from":"M", "to":"latest"},
            "propertyName":{"ja":"すすぎモード設定", "en":"Rinsing mode setting"},
            "accessRule":{"get":"optional", "set":"optional", "inf":"optional"},
            "data":{ "$ref":"#/definitions/raw_4" }
        },
        "0xDC":{
            "validRelease":{"from":"M", "to":"latest"},
            "propertyName":{"ja":"熱水すすぎ最高水温設定値", "en":"Highest water temperature setting for hot water rinsing"},
            "accessRule":{"get":"optional", "set":"optional", "inf":"optional"},
            "data":{
                "oneOf":[
                    { "$ref":"#/definitions/number_0-100Celsius" },
        ...
        "0xDD":{
            "validRelease":{"from":"M", "to":"latest"},
            "propertyName":{"ja":"洗浄水量設定", "en":"Dish-washing water volume setting"},
            "accessRule":{"get":"optional", "set":"optional", "inf":"optional"},
            "data":{
                "oneOf":[
                    { "$ref":"#/definitions/level_31-16" },
        ...
        "0xDE":{
            "validRelease":{"from":"M", "to":"latest"},
            "propertyName":{"ja":"洗浄水圧設定", "en":"Dish-washing water pressure setting"},
            "accessRule":{"get":"optional", "set":"optional", "inf":"optional"},
            "data":{
                "oneOf":[
                    { "$ref":"#/definitions/level_31-16" },
        ...
        "0xDF":{
            "validRelease":{"from":"M", "to":"latest"},
            "propertyName":{"ja":"洗浄度設定", "en":"Dish-washing level setting"},
            "accessRule":{"get":"optional", "set":"optional", "inf":"optional"},
            "data":{
                "oneOf":[
                    { "$ref":"#/definitions/level_31-16" },
        ...
        "0xE1":{
            "validRelease":{"from":"M", "to":"latest"},
            "propertyName":{"ja":"熱風乾燥最高気温設定値", "en":"Highest air temperature setting for hot air drying"},
            "accessRule":{"get":"optional", "set":"optional", "inf":"optional"},
            "data":{
                "oneOf":[
        ...
        "0xE2":{
            "validRelease":{"from":"M", "to":"latest"},
            "propertyName":{"ja":"乾燥風量設定", "en":"Drying air flow rate setting"},
            "accessRule":{"get":"optional", "set":"optional", "inf":"optional"},
            "data":{
                "oneOf":[
                    { "$ref":"#/definitions/level_31-16" },
        ...
        "0xE3":{
            "validRelease":{"from":"M", "to":"latest"},
            "propertyName":{"ja":"乾燥度設定", "en":"Drying level setting"},
            "accessRule":{"get":"optional", "set":"optional", "inf":"optional"},
            "data":{
                "oneOf":[
                    { "$ref":"#/definitions/level_31-16" },
        ...
        "0xE4":{
            "validRelease":{"from":"M", "to":"latest"},
            "propertyName":{"ja":"保管時間設定値", "en":"Storing time setting"},
            "accessRule":{"get":"optional", "set":"optional", "inf":"optional"},
            "data":{ "$ref":"#/definitions/raw_3" }
        },
        "0xE5":{
            "validRelease":{"from":"M", "to":"latest"},
            "propertyName":{"ja":"運転設定情報", "en":"Operation setting information"},
            "accessRule":{"get":"optional", "set":"notApplicable", "inf":"optional"},
            "data":{ "$ref":"#/definitions/raw_27" }
        },
        "0xE6":{
            "validRelease":{"from":"M", "to":"latest"},
            "propertyName":{"ja":"運転遷移状態", "en":"Operation transition status"},
            "accessRule":{"get":"required", "set":"notApplicable", "inf":"required"},
            "data":{
                "type":"state",
                "size":1,
                "enum":[
                    {"edt":"0x10", "state":{"ja":"運転開始前", "en":"Before starting operation"}},
                    {"edt":"0x11", "state":{"ja":"運転前", "en":"Before operation"}},
                    {"edt":"0x14", "state":{"ja":"ON タイマ待機中", "en":"ON timer standing by"}},
                    {"edt":"0x30", "state":{"ja":"洗浄中", "en":"Dish-washing ongoing"}},
                    {"edt":"0x31", "state":{"ja":"予洗い中", "en":"Prewashing ongoing"}},
                    {"edt":"0x34", "state":{"ja":"本洗い中", "en":"Washing ongoing"}},
                    {"edt":"0x37", "state":{"ja":"すすぎ中", "en":"Rinsing ongoing"}},
                    {"edt":"0x3F", "state":{"ja":"洗浄一時停止", "en":"Dish-washing suspended"}},
                    {"edt":"0x50", "state":{"ja":"乾燥中", "en":"Drying ongoing"}},
                    {"edt":"0x51", "state":{"ja":"熱風乾燥中", "en":"Hot air drying ongoing"}},
                    {"edt":"0x54", "state":{"ja":"風乾燥中", "en":"Air drying ongoing"}},
                    {"edt":"0x5F", "state":{"ja":"乾燥一時停止", "en":"Drying suspended"}},
                    {"edt":"0x70", "state":{"ja":"保管中", "en":"Storing ongoing"}},
                    {"edt":"0x71", "state":{"ja":"送風中", "en":"Blowing ongoing"}},
                    {"edt":"0x74", "state":{"ja":"除湿中", "en":"Dehumidification ongoing"}},
                    {"edt":"0x77", "state":{"ja":"除菌中", "en":"Disinfection ongoing"}},
                    {"edt":"0x7F", "state":{"ja":"保管一時停止", "en":"Storing suspended"}},
                    {"edt":"0x90", "state":{"ja":"運転完了", "en":"Operation completed"}},
                    {"edt":"0xB1", "state":{"ja":"第１すすぎ", "en":"1st rinsing"}},
                    {"edt":"0xB2", "state":{"ja":"第２すすぎ", "en":"2nd rinsing"}},
                    {"edt":"0xB3", "state":{"ja":"第３すすぎ", "en":"3rd rinsing"}},
                    {"edt":"0xB4", "state":{"ja":"第４すすぎ", "en":"4th rinsing"}},
                    {"edt":"0xB5", "state":{"ja":"第５すすぎ", "en":"5th rinsing"}},
                    {"edt":"0xB6", "state":{"ja":"第６すすぎ", "en":"6th rinsing"}},
                    {"edt":"0xB7", "state":{"ja":"第７すすぎ", "en":"7th rinsing"}},
                    {"edt":"0xB8", "state":{"ja":"第８すすぎ", "en":"8th rinsing"}},
                    {"edt":"0xFF", "state":{"ja":"状態不明", "en":"Unknown status"}}
                ]
            }
        },
        "0xE7":{
            "validRelease":{"from":"M", "to":"latest"},
            "propertyName":{"ja":"ON タイマ残り時間", "en":"Remaining time on the ON timer"},
            "accessRule":{"get":"optional", "set":"notApplicable", "inf":"optional"},
            "data":{
                "oneOf":[
                    { "type":"time", "size":2 },
        ...
        "0xE8":{
            "validRelease":{"from":"M", "to":"latest"},
            "propertyName":{"ja":"予洗い残り時間", "en":"Remaining time of prewashing"},
            "accessRule":{"get":"optional", "set":"notApplicable", "inf":"optional"},
            "data":{
                "oneOf":[
                    { "type":"time", "size":2 },
        ...
        "0xE9":{
            "validRelease":{"from":"M", "to":"latest"},
            "propertyName":{"ja":"本洗い残り時間", "en":"Remaining time of washing"},
            "accessRule":{"get":"optional", "set":"notApplicable", "inf":"optional"},
            "data":{
                "oneOf":[
                    { "type":"time", "size":2 },
        ...
        "0xEA":{
            "validRelease":{"from":"M", "to":"latest"},
            "propertyName":{"ja":"すすぎ残り時間", "en":"Remaining time for rinsing"},
            "accessRule":{"get":"optional", "set":"notApplicable", "inf":"optional"},
            "data":{
                "oneOf":[
                    { "type":"time", "size":2 },
        ...
        "0xEB":{
            "validRelease":{"from":"M", "to":"latest"},
            "propertyName":{"ja":"洗浄残り時間", "en":"Remaining time of dish-washing"},
            "accessRule":{"get":"optional", "set":"notApplicable", "inf":"optional"},
            "data":{
                "oneOf":[
                    { "type":"time", "size":2 },
        ...
        "0xED":{
            "validRelease":{"from":"M", "to":"latest"},
            "propertyName":{"ja":"洗乾残り時間", "en":"Remaining time of washing and drying"},
            "accessRule":{"get":"optional", "set":"notApplicable", "inf":"optional"},
            "data":{
                "oneOf":[
                    { "type":"time", "size":2 },
        ...
        "0xEF":{
            "validRelease":{"from":"M", "to":"latest"},
            "propertyName":{"ja":"使用水量", "en":"Used water volume"},
            "accessRule":{"get":"optional", "set":"notApplicable", "inf":"optional"},
            "data":{
                "oneOf":[
                    { "$ref":"#/definitions/number_0-65534", "unit":"L", "multipleOf":0.01 },
                    { "$ref":"#/definitions/state_Undefined-FFFF" }
                ]
            }
        }
...
"0x05FA":{
    ...
    "elProperties":{
        "0xC0":{
            ...
            "accessRule":{"get":"notApplicable", "set":"required", "inf":"notApplicable"},
            "data":{ "$ref":"#/definitions/raw_3" }
        },
        "0xC1":{
            "validRelease":{"from":"H", "to":"latest"},
