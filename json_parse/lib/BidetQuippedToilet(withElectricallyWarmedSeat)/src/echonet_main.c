...
struct bidet-quipped_toilet(with_electrically_warmed_seat)_t bidet-quipped_toilet(with_electrically_warmed_seat)_class_data = {
};
void heater_setting_of_toilet_seat_prop_set (const EPRPINIB *item, const void *src, int size, bool_t *anno)
{
