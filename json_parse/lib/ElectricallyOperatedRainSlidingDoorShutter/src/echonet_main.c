...
#include "gpio_api.h"
#include "rtc_api.h"
#include "tECNLElectricallyOperatedRainSlidingDoorShutter_tecsgen.h"
...
struct electrically_operated_rain_sliding_door/shutter_t electrically_operated_rain_sliding_door/shutter_class_data = {
};
...
int open/close_setting_prop_set (const EPRPINIB *item, const void *src, int size, bool_t *anno)
{
    ...
    *anno = *((uint8_t*)item->exinf) != *((uint8_t*)src);
    switch (*(uint8_t*)src) {
      case 0x41: tECNLElectricallyOperatedRainSlidingDoorShutter_cElectricallyOperatedRainSlidingDoorShutter_setOpenCloseSetting_Open( );
        break;
      case 0x42: tECNLElectricallyOperatedRainSlidingDoorShutter_cElectricallyOperatedRainSlidingDoorShutter_setOpenCloseSetting_Close( );
        break;
      case 0x43: tECNLElectricallyOperatedRainSlidingDoorShutter_cElectricallyOperatedRainSlidingDoorShutter_setOpenCloseSetting_Stop( );
        break;
default:
        return 0;
	}return 1;
...
int onoff_prop_set(const EPRPINIB *item, const void *src, int size, bool_t *anno)
{
	...
	*anno = *((uint8_t*)item->exinf) != *((uint8_t*)src);
	switch(*(uint8_t *)src){
	case 0x30: tECNLElectricallyOperatedRainSlidingDoorShutter_cElectricallyOperatedRainSlidingDoorShutter_setOperatingStatus_ON( );
		break;
	case 0x31: tECNLElectricallyOperatedRainSlidingDoorShutter_cElectricallyOperatedRainSlidingDoorShutter_setOperatingStatus_OFF( );
		break;
	default:
		return 0;
	}return 1;
...
int alarm_prop_set(const EPRPINIB *item, const void *src, int size, bool_t *anno)
{
	...
	*anno = *((uint8_t *)item->exinf) != *((uint8_t *)src);
	switch(*(uint8_t *)src){
	case 0x41: tECNLElectricallyOperatedRainSlidingDoorShutter_cElectricallyOperatedRainSlidingDoorShutter_setFaultStatus_Fault( );
	case 0x42: tECNLElectricallyOperatedRainSlidingDoorShutter_cElectricallyOperatedRainSlidingDoorShutter_setFaultStatus_NoFault( );
