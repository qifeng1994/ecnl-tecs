...
struct low-voltage_smart_electric_energy_meter_t low-voltage_smart_electric_energy_meter_class_data = {
};
void dayForWhichTheHistoricalDataOfMeasuredCumulativeAmountsOfElectricEnergyIsToBeRetrieved1_prop_set (const EPRPINIB *item, const void *src, int size, bool_t *anno)
{
