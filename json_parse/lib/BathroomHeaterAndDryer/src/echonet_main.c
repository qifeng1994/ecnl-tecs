...
#include "gpio_api.h"
#include "rtc_api.h"
#include "tECNLBathroomHeaterAndDryer_tecsgen.h"
...
struct bathroom_heater_and_dryer_t bathroom_heater_and_dryer_class_data = {
};
struct node_profile_object_t local_node_data = {
};
int bathroom_dryer_operation_setting_prop_set (const EPRPINIB *item, const void *src, int size, bool_t *anno)
{
    ...
    *anno = *((uint8_t*)item->exinf) != *((uint8_t*)src);
    switch (*(uint8_t*)src) {
      case 0x41: tECNLBathroomHeaterAndDryer_cBathroomHeaterAndDryer_setBathroomDryerOperationSetting_Automatic( );
        break;
      case 0x42: tECNLBathroomHeaterAndDryer_cBathroomHeaterAndDryer_setBathroomDryerOperationSetting_Standard( );
        break;
default:
        return 0;
	}return 1;
...
int onoff_prop_set(const EPRPINIB *item, const void *src, int size, bool_t *anno)
{
	...
	*anno = *((uint8_t*)item->exinf) != *((uint8_t*)src);
	switch(*(uint8_t *)src){
	case 0x30: tECNLBathroomHeaterAndDryer_cBathroomHeaterAndDryer_setOperatingStatus_ON( );
		break;
	case 0x31: tECNLBathroomHeaterAndDryer_cBathroomHeaterAndDryer_setOperatingStatus_OFF( );
		break;
	default:
		return 0;
	}return 1;
...
int alarm_prop_set(const EPRPINIB *item, const void *src, int size, bool_t *anno)
{
	...
	*anno = *((uint8_t *)item->exinf) != *((uint8_t *)src);
	switch(*(uint8_t *)src){
	case 0x41: tECNLBathroomHeaterAndDryer_cBathroomHeaterAndDryer_setFaultStatus_Fault( );
	case 0x42: tECNLBathroomHeaterAndDryer_cBathroomHeaterAndDryer_setFaultStatus_NoFault( );
