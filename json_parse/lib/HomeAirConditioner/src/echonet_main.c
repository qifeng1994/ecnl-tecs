...
struct home_air_conditioner_t home_air_conditioner_class_data = {
};
void power-saving_operation_setting_prop_set (const EPRPINIB *item, const void *src, int size, bool_t *anno)
{
