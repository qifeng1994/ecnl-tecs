...
void dayForWhichTheHistoricalDataOfMeasuredCumulativeAmountsOfElectricEnergyIsToBeRetrieved_prop_set (const EPRPINIB *item, const void *src, int size, bool_t *anno)
{
