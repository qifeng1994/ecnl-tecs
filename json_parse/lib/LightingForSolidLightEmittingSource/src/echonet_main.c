...
#include "gpio_api.h"
#include "rtc_api.h"
#include "tECNLLightingForSolidLightEmittingSource_tecsgen.h"
...
struct lighting_for_solid_light-emitting_source_t lighting_for_solid_light-emitting_source_class_data = {
};
...
int onoff_prop_set(const EPRPINIB *item, const void *src, int size, bool_t *anno)
{
	...
	*anno = *((uint8_t*)item->exinf) != *((uint8_t*)src);
	switch(*(uint8_t *)src){
	case 0x30: tECNLLightingForSolidLightEmittingSource_cLightingForSolidLightEmittingSource_setOperatingStatus_ON( );
		break;
	case 0x31: tECNLLightingForSolidLightEmittingSource_cLightingForSolidLightEmittingSource_setOperatingStatus_OFF( );
		break;
	default:
		return 0;
	}return 1;
...
int alarm_prop_set(const EPRPINIB *item, const void *src, int size, bool_t *anno)
{
	...
	*anno = *((uint8_t *)item->exinf) != *((uint8_t *)src);
	switch(*(uint8_t *)src){
	case 0x41: tECNLLightingForSolidLightEmittingSource_cLightingForSolidLightEmittingSource_setFaultStatus_Fault( );
	case 0x42: tECNLLightingForSolidLightEmittingSource_cLightingForSolidLightEmittingSource_setFaultStatus_NoFault( );
