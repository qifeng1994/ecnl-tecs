...
#include "gpio_api.h"
#include "rtc_api.h"
#include "tECNLCommercialShowCaseOutdoorUnit_tecsgen.h"
...
struct commercial_show_case_outdoor_unit_t commercial_show_case_outdoor_unit_class_data = {
};
...
int operation_mode_setting_prop_set (const EPRPINIB *item, const void *src, int size, bool_t *anno)
{
    ...
    *anno = *((uint8_t*)item->exinf) != *((uint8_t*)src);
    switch (*(uint8_t*)src) {
      case 0x41: tECNLCommercialShowCaseOutdoorUnit_cCommercialShowCaseOutdoorUnit_setOperationModeSetting_Cooling( );
        break;
      case 0x42: tECNLCommercialShowCaseOutdoorUnit_cCommercialShowCaseOutdoorUnit_setOperationModeSetting_NonCooling( );
        break;
default:
        return 0;
	}return 1;
...
int onoff_prop_set(const EPRPINIB *item, const void *src, int size, bool_t *anno)
{
	...
	*anno = *((uint8_t*)item->exinf) != *((uint8_t*)src);
	switch(*(uint8_t *)src){
	case 0x30: tECNLCommercialShowCaseOutdoorUnit_cCommercialShowCaseOutdoorUnit_setOperatingStatus_ON( );
		break;
	case 0x31: tECNLCommercialShowCaseOutdoorUnit_cCommercialShowCaseOutdoorUnit_setOperatingStatus_OFF( );
		break;
	default:
		return 0;
	}return 1;
...
int alarm_prop_set(const EPRPINIB *item, const void *src, int size, bool_t *anno)
{
	...
	*anno = *((uint8_t *)item->exinf) != *((uint8_t *)src);
	switch(*(uint8_t *)src){
	case 0x41: tECNLCommercialShowCaseOutdoorUnit_cCommercialShowCaseOutdoorUnit_setFaultStatus_Fault( );
	case 0x42: tECNLCommercialShowCaseOutdoorUnit_cCommercialShowCaseOutdoorUnit_setFaultStatus_NoFault( );
