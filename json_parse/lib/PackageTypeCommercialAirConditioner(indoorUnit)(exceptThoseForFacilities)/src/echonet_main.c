...
struct package-type_commercial_air_conditioner_(indoor_unit)_(except_those_for_facilities)_t package-type_commercial_air_conditioner_(indoor_unit)_(except_those_for_facilities)_class_data = {
};
