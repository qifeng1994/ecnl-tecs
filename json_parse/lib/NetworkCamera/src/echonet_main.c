...
struct network_camera_t network_camera_class_data = {
};
void still_image_photography_setting_prop_set (const EPRPINIB *item, const void *src, int size, bool_t *anno)
{
