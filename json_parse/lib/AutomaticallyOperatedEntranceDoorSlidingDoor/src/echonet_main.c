...
#include "gpio_api.h"
#include "rtc_api.h"
#include "tECNLAutomaticallyOperatedEntranceDoorSlidingDoor_tecsgen.h"
...
struct automatically_operated_entrance_door/sliding_door_t automatically_operated_entrance_door/sliding_door_class_data = {
};
...
int open/close_setting_prop_set (const EPRPINIB *item, const void *src, int size, bool_t *anno)
{
    ...
    *anno = *((uint8_t*)item->exinf) != *((uint8_t*)src);
    switch (*(uint8_t*)src) {
      case 0x41: tECNLAutomaticallyOperatedEntranceDoorSlidingDoor_cAutomaticallyOperatedEntranceDoorSlidingDoor_setOpenCloseSetting_Open( );
        break;
      case 0x42: tECNLAutomaticallyOperatedEntranceDoorSlidingDoor_cAutomaticallyOperatedEntranceDoorSlidingDoor_setOpenCloseSetting_Close( );
        break;
      case 0x43: tECNLAutomaticallyOperatedEntranceDoorSlidingDoor_cAutomaticallyOperatedEntranceDoorSlidingDoor_setOpenCloseSetting_Stop( );
        break;
default:
        return 0;
	}return 1;
...
int onoff_prop_set(const EPRPINIB *item, const void *src, int size, bool_t *anno)
{
	...
	*anno = *((uint8_t*)item->exinf) != *((uint8_t*)src);
	switch(*(uint8_t *)src){
	case 0x30: tECNLAutomaticallyOperatedEntranceDoorSlidingDoor_cAutomaticallyOperatedEntranceDoorSlidingDoor_setOperatingStatus_ON( );
		break;
	case 0x31: tECNLAutomaticallyOperatedEntranceDoorSlidingDoor_cAutomaticallyOperatedEntranceDoorSlidingDoor_setOperatingStatus_OFF( );
		break;
	default:
		return 0;
	}return 1;
...
int alarm_prop_set(const EPRPINIB *item, const void *src, int size, bool_t *anno)
{
	...
	*anno = *((uint8_t *)item->exinf) != *((uint8_t *)src);
	switch(*(uint8_t *)src){
	case 0x41: tECNLAutomaticallyOperatedEntranceDoorSlidingDoor_cAutomaticallyOperatedEntranceDoorSlidingDoor_setFaultStatus_Fault( );
	case 0x42: tECNLAutomaticallyOperatedEntranceDoorSlidingDoor_cAutomaticallyOperatedEntranceDoorSlidingDoor_setFaultStatus_NoFault( );
