...
#include "gpio_api.h"
#include "rtc_api.h"
#include "tECNLHouseholdSolarPowerGeneration_tecsgen.h"
...
struct household_solar_power_generation_t household_solar_power_generation_class_data = {
};
struct node_profile_object_t local_node_data = {
};
int fit_contract_type_prop_set (const EPRPINIB *item, const void *src, int size, bool_t *anno)
{
    ...
    *anno = *((uint8_t*)item->exinf) != *((uint8_t*)src);
    switch (*(uint8_t*)src) {
      case 0x41: tECNLHouseholdSolarPowerGeneration_cHouseholdSolarPowerGeneration_setFitContractType_Fit( );
        break;
      case 0x42: tECNLHouseholdSolarPowerGeneration_cHouseholdSolarPowerGeneration_setFitContractType_NonFit( );
        break;
      case 0x43: tECNLHouseholdSolarPowerGeneration_cHouseholdSolarPowerGeneration_setFitContractType_NoSetting( );
        break;
default:
        return 0;
	}return 1;
...
int onoff_prop_set(const EPRPINIB *item, const void *src, int size, bool_t *anno)
{
	...
	*anno = *((uint8_t*)item->exinf) != *((uint8_t*)src);
	switch(*(uint8_t *)src){
	case 0x30: tECNLHouseholdSolarPowerGeneration_cHouseholdSolarPowerGeneration_setOperatingStatus_ON( );
		break;
	case 0x31: tECNLHouseholdSolarPowerGeneration_cHouseholdSolarPowerGeneration_setOperatingStatus_OFF( );
		break;
	default:
		return 0;
	}return 1;
...
int alarm_prop_set(const EPRPINIB *item, const void *src, int size, bool_t *anno)
{
	...
	*anno = *((uint8_t *)item->exinf) != *((uint8_t *)src);
	switch(*(uint8_t *)src){
	case 0x41: tECNLHouseholdSolarPowerGeneration_cHouseholdSolarPowerGeneration_setFaultStatus_Fault( );
	case 0x42: tECNLHouseholdSolarPowerGeneration_cHouseholdSolarPowerGeneration_setFaultStatus_NoFault( );
