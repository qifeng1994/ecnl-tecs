...
const TINIB _kernel_tinib_table[TNUM_STSKID] = {
	{ (TA_ACT), (intptr_t)(&tTask_INIB_tab[0]), (TASK)(tTask_start), INT_PRIORITY(3), ROUND_STK_T(4096), _kernel_stack_TSKID_tTask_LogTask_Task, "tTask_start" },
	{ (TA_NULL), (intptr_t)(1), (TASK)(task), INT_PRIORITY(MID_PRIORITY), ROUND_STK_T(STACK_SIZE), _kernel_stack_TASK1, "task" },
	{ (TA_NULL), (intptr_t)(2), (TASK)(task), INT_PRIORITY(MID_PRIORITY), ROUND_STK_T(STACK_SIZE), _kernel_stack_TASK2, "task" },
	{ (TA_ACT), (intptr_t)(0), (TASK)(main_task), INT_PRIORITY(MAIN_PRIORITY), ROUND_STK_T(STACK_SIZE), _kernel_stack_MAIN_TASK, "main_task" },
	{ (TA_NULL), (intptr_t)(0), (TASK)(exc_task), INT_PRIORITY(EXC_PRIORITY), ROUND_STK_T(STACK_SIZE), _kernel_stack_EXC_TASK, "exc_task" }
};
...
const ID _kernel_torder_table[TNUM_STSKID] = { 
	TSKID_tTask_LogTask_Task, TASK1, TASK2, MAIN_TASK, EXC_TASK
};
