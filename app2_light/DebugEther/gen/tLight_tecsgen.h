...
typedef struct tag_tLight_CB {
    int  dummy;
} tLight_CB;
/* singleton cell CB prototype declaration #_MCPB_# */

/* celltype IDX type #_CTIX_# */
typedef int   tLight_IDX;

/* prototype declaration of entry port function #_EPP_# */
/* sLight */
void         tLight_eLight_setOn(tLight_IDX idx);
void         tLight_eLight_setOff(tLight_IDX idx);
#ifdef __cplusplus
}
#endif /* __cplusplus */
...
#define tLight_GET_CELLCB(idx) ((void *)0)
#ifndef TECSFLOW
#else  /* TECSFLOW */
#endif /* TECSFLOW */
...
#define eLight_setOn     tLight_eLight_setOn
#define eLight_setOff    tLight_eLight_setOff
